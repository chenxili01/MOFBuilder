...
class FrameLinker:
    ...
    def create_pdb(self, filename, lines):
        ...
        data, x_data, _attachment_data_by_type = self.pdbreader.expand_arr2data(lines)
    ...
    def create(self, molecule=None):
        ...
        self.linker_center_data, self.linker_center_X_data, self.linker_center_attachment_data_by_type = self.pdbreader.expand_arr2data(
            self.lines)
        self.linker_outer_data, self.linker_outer_X_data, self.linker_outer_attachment_data_by_type = self.pdbreader.expand_arr2data(
            self.rows)
